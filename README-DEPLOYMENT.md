...
Si votre repository a un nom différent, modifiez la base dans `vite.config.standalone.ts` :
...
- Contrôlez que le workflow de déploiement s'est exécuté sans erreur
